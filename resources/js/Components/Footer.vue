      ...
      >
        ...
        <div class="text-center sm:text-left">
          ...
          <nav class="mt-8">
            <ul class="space-y-4 text-sm">
              <li>
                <a class="text-white transition hover:text-white/75" target="_blank" href="https://www.reddit.com/r/VirtualRealityGaming/">
                  FAQs
                </a>
              </li>
          ...
          <ul class="mt-8 space-y-4 text-sm">
            ...
            >
              ...
              <address class="-mt-0.5 not-italic text-white">
                <a class="text-white transition hover:text-white/75" target="_blank" href="https://vrclist.com/world/10442">
                  Festival Plaza
                </a>
              </address>
            </li>
